...
///已发布TopButton菜单
App.Doc.Content.TopButton.push({ Name: "已发布文档", ID: "TopButton.已发布文档", Method: "",  ParentID: null , Type: "Title", GroupID: "左侧菜单.已发布.TopButton"});
...
App.Doc.Content.TopButton.push({ Name: "新建文章", ID: "TopButton.新建文章", Method: "Doc.TopButtonClick", Param: App.Doc.Server.Url3,  ParentID: "ptcd", GroupID: "左侧菜单.待发布.TopButton" });
App.Doc.Content.TopButton.push({ Name: "新建目录", ID: "TopButton.新建目录", Method: "Doc.TopButtonClick", Param: App.Doc.Server.Url6,  ParentID: "ptcd", GroupID: "左侧菜单.待发布.TopButton" });
App.Doc.Content.TopButton.push({ Name: "|", ID: "TopButton.|.1", Method: "",  ParentID: "ptcd", GroupID: "左侧菜单.待发布.TopButton" });
...
App.Doc.Content.TopButton.push({ Name: "删除", ID: "TopButton.删除", Method: "Doc.TopButtonClick",  ParentID: "glcd", GroupID: "左侧菜单.待发布.TopButton" });
///草稿箱TopButton菜单
App.Doc.Content.TopButton.push({ Name: "草稿箱文档", ID: "TopButton.草稿箱文档", Method: "",  ParentID: null, GroupID: "", Type: "Title", GroupID: "左侧菜单.草稿箱.TopButton" });
App.Doc.Content.TopButton.push({ Name: "|", ID: "TopButton.|.1", Method: "",  ParentID: "ptcd", GroupID: "左侧菜单.草稿箱.TopButton" });
App.Doc.Content.TopButton.push({ Name: "新建文章", ID: "TopButton.新建文章", Method: "Doc.TopButtonClick", Param: App.Doc.Server.Url3,  ParentID: "ptcd", GroupID: "左侧菜单.草稿箱.TopButton" });
App.Doc.Content.TopButton.push({ Name: "新建目录", ID: "TopButton.新建目录", Method: "Doc.TopButtonClick", Param: App.Doc.Server.Url6,  ParentID: "ptcd", GroupID: "左侧菜单.草稿箱.TopButton" });
App.Doc.Content.TopButton.push({ Name: "|", ID: "TopButton.|.1", Method: "",  ParentID: "ptcd", GroupID: "左侧菜单.草稿箱.TopButton" });
...
App.Doc.Content.TopButton.push({ Name: "删除", ID: "", Method: "Doc.TopButtonClick",  ParentID: "glcd", GroupID: "左侧菜单.草稿箱.TopButton" });
...
App.Doc.Content.TopButton.push({ Name: "新建文章", ID: "", Method: "Doc.TopButtonClick", Param: App.Doc.Server.Url3,  ParentID: "ptcd", GroupID: "左侧菜单.全部文档.TopButton" });
App.Doc.Content.TopButton.push({ Name: "新建目录", ID: "", Method: "Doc.TopButtonClick", Param: App.Doc.Server.Url6,  ParentID: "ptcd", GroupID: "左侧菜单.全部文档.TopButton" });
App.Doc.Content.TopButton.push({ Name: "|", ID: "", Method: "",  ParentID: "ptcd", GroupID: "左侧菜单.全部文档.TopButton" });
...
App.Doc.Content.TopButton.push({ Name: "删除", ID: "", Method: "Doc.TopButtonClick",  ParentID: "glcd", GroupID: "左侧菜单.全部文档.TopButton" });
