...
App.Doc.Data.RecycleBin.Info.Pager.PagerIndexClick = function () {
    ...
    var index = $(event.target).attr("data-Index");
    var query = [{ _RedirectID: null, CompanyID: SESSION.Current().CompanyID, 'StatusCode': { $eq: -1 } }, { Content: 0, PlainText: 0,Summary:0 }, { CreateTime: -1 }];
