...
App.Doc.LeftMenu.push({ Name: "流程操作", ID: "LeftMenu.文档操作", Method: "Doc.LeftMenuGroupToggle",    ParentID: null });
App.Doc.LeftMenu.push({ Name: "新建流程", ID: "LeftMenu.新建文章", Method: "Doc.LeftMenuClick",    ParentID: "LeftMenu.文档操作" });
...
App.Doc.LeftMenu.push({ Name: "我的流程", ID: "LeftMenu.待发布", Method: "Doc.LeftMenuClick",   ParentID: "LeftMenu.文档操作", TopButtonGroupID: "左侧菜单.待发布.TopButton"  });
App.Doc.LeftMenu.push({ Name: "已完成", ID: "LeftMenu.已发布", Method: "Doc.LeftMenuClick",   ParentID: "LeftMenu.文档操作", TopButtonGroupID:"左侧菜单.已发布.TopButton" });
App.Doc.LeftMenu.push({ Name: "画流程图", ID: "LeftMenu.全部文档", Method: "Doc.LeftMenuClick",  ParentID: "LeftMenu.文档操作", TopButtonGroupID: "左侧菜单.全部文档.TopButton" });
