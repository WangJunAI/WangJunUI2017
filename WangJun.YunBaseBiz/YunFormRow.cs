...
namespace WangJun.Yun
{
    ...
    /// 云表单
    /// </summary>
    public class YunFormRow:BaseFormRow
    {
        public YunFormRow()
        {
            ...
            iSysItem._CollectionName = "YunFormRow";
        ...
        public int Save()
        {
            ...
            if (null != iSysItem)
            {
                EntityManager.GetInstance().Save<YunFormRow>(this);
        ...
        {
            var inst =Convertor.FromJsonToObject2<YunFormRow>(jsonInput);
            var res=inst.Save();
        ...
        public static YunFormRow Load(string id)
        {
            var res = EntityManager.GetInstance().Get<YunFormRow>(id);
            return res;
        }

        public static int Remove(string id)
        {
            return EntityManager.GetInstance().Remove<YunFormRow>(id);
        }

        public static int Delete(string id)
        {
            return EntityManager.GetInstance().DeleteOne<YunFormRow>(id);
        }

        #region 基本方法
        public static YunFormRow CreateAsHtml()
        {
            var inst = new YunFormRow();
