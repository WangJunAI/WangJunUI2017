...
App.Doc.CSS.LeftList.View3.Width = { Value: 12, Unit: "em" };
 ...
 App.Doc.Server = {
    ...
    Url6: "Category.html",
    Url7: "http://localhost:9990/API.ashx?c=WangJun.Doc.YunProjectWebAPI&m=SaveCategory",///保存一个目录
    Url8: "http://localhost:9990/API.ashx?c=WangJun.Doc.YunProjectWebAPI&m=LoadCategoryList",///加载目录列表
    Url9: "http://localhost:9990/API.ashx?c=WangJun.Doc.DocWebAPI&m=RemoveDoc",///移除一份文档,暂未使用
    Url10: "http://localhost:9990/API.ashx?c=WangJun.Doc.YunProjectWebAPI&m=RemoveCategory",///移除一个目录
    Url11: "http://localhost:9990/API.ashx?c=WangJun.Doc.YunProjectWebAPI&m=GetCategory", ///获取一个目录
    ...
    Url18: "http://localhost:9990/API.ashx?c=WangJun.Doc.DocWebAPI&m=RecycleBinCount",///回收站数量
...
App.Doc.LeftMenu.push({ Name: "项目管理", ID: "LeftMenu.文档操作", Method: "Doc.LeftMenuGroupToggle",    ParentID: null });
App.Doc.LeftMenu.push({ Name: "新建项目", ID: "LeftMenu.新建文章", Method: "Doc.LeftMenuClick",    ParentID: "LeftMenu.文档操作" });
App.Doc.LeftMenu.push({ Name: "新建分组", ID: "LeftMenu.新建目录", Method: "Doc.LeftMenuClick",  ParentID: "LeftMenu.文档操作" });
...
App.Doc.LeftMenu.push({ Name: "进行中", ID: "LeftMenu.待发布", Method: "Doc.LeftMenuClick",   ParentID: "LeftMenu.文档操作", TopButtonGroupID: "左侧菜单.待发布.TopButton"  });
App.Doc.LeftMenu.push({ Name: "已完整", ID: "LeftMenu.已发布", Method: "Doc.LeftMenuClick",   ParentID: "LeftMenu.文档操作", TopButtonGroupID:"左侧菜单.已发布.TopButton" });
App.Doc.LeftMenu.push({ Name: "全部项目", ID: "LeftMenu.全部文档", Method: "Doc.LeftMenuClick",  ParentID: "LeftMenu.文档操作", TopButtonGroupID: "左侧菜单.全部文档.TopButton" });
