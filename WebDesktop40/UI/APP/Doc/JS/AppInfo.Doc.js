...
App.Doc.CSS.LeftList.View3.Width = { Value: 12, Unit: "em" };
 ...
 App.Doc.Server = {
    ...
    Url6: "Category.html",
    Url7: "http://localhost:9990/API.ashx?c=WangJun.YunDoc.YunDocWebAPI&m=SaveCategory",///保存一个目录
    Url8: "http://localhost:9990/API.ashx?c=WangJun.YunDoc.YunDocWebAPI&m=LoadCategoryList",///加载目录列表
    Url9: "http://localhost:9990/API.ashx?c=WangJun.YunDoc.YunDocWebAPI&m=RemoveEntity",///移除一份文档,暂未使用
    Url10: "http://localhost:9990/API.ashx?c=WangJun.YunDoc.YunDocWebAPI&m=RemoveCategory",///移除一个目录
    Url11: "http://localhost:9990/API.ashx?c=WangJun.YunDoc.YunDocWebAPI&m=GetCategory", ///获取一个目录
    Url12: "http://aifuwu.wang/API.ashx?c=WangJun.YunDoc.DocManager&m=UpdateStatus&p=0",///暂未使用
    Url13: "http://aifuwu.wang/API.ashx?c=WangJun.YunDoc.YunDocWebAPI&m=MoveToRecycleBin", ///移除到回收站
    Url14: "http://aifuwu.wang/API.ashx?c=WangJun.YunDoc.DocWebAPI&m=LoadRecycleBinItem",///加载回收站
...
App.Doc.LeftMenu.push({ Name: "我的文档", ID: "LeftMenu.文档操作", Method: "Doc.LeftMenuGroupToggle",    ParentID: null });
App.Doc.LeftMenu.push({ Name: "新建文档", ID: "LeftMenu.新建文档", Method: "Doc.LeftMenuClick",    ParentID: "LeftMenu.文档操作" });
...
App.Doc.LeftMenu.push({ Name: "企业文档", ID: "LeftMenu.企业文档", Method: "Doc.LeftMenuClick", ParentID: "LeftMenu.文档操作", TopButtonGroupID: "左侧菜单.个人文档.TopButton" });
...
App.Doc.Content.TopButton.push({ Name: "新建文档", ID: "TopButton.新建文档", Method: "Doc.TopButtonClick", Param: App.Doc.Server.Url3,   GroupID: "左侧菜单.待发布.TopButton" });
...
App.Doc.Content.TopButton.push({ Name: "新建文档", ID: "TopButton.新建文档", Method: "Doc.TopButtonClick", Param: App.Doc.Server.Url3,   GroupID: "左侧菜单.草稿箱.TopButton" });
...
App.Doc.Content.TopButton.push({ Name: "新建文档", ID: "TopButton.新建文档", Method: "Doc.TopButtonClick", Param: App.Doc.Server.Url3,    GroupID: "左侧菜单.全部文档.TopButton" });
